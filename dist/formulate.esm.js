...
import { resolveComponent, openBlock, createElementBlock, mergeProps, withModifiers, createBlock, toHandlers, createCommentVNode, renderSlot, normalizeProps, guardReactiveProps, normalizeClass, createElementVNode, resolveDynamicComponent, withCtx, toDisplayString, normalizeStyle, Fragment, renderList, createVNode, withDirectives, vModelRadio, vModelCheckbox, vModelDynamic, createTextVNode, vShow, vModelSelect, vModelText, withKeys } from 'vue';
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", {
    ...
    createElementVNode("button", mergeProps({ type: _ctx.type }, _ctx.attributes, toHandlers(_ctx.$listeners, true)), [
